import type { WindData, ActiveSpecies } from '../utils/api';
...
export default function Header({ weather, activeSpecies }: HeaderProps) {
    ...
    <header className="bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between shadow-sm">
      <div className="flex items-center gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">Gunn High School, Palo Alto</p>
        </div>
      </div>
