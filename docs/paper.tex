...
Table~\ref{tab:species} lists the temporal parameters for the seven genera modeled on campus, derived from Bay Area regional data \citep{bastl2016}. Most bloom in late winter through spring; Cedar (\emph{Cedrus}) is the notable exception, pollinating in the fall (October--December), so it produces a secondary autumn peak that the other genera do not.
